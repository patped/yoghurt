...
<div class="loginn">
	...
	<?php 
		...
		$id = $_GET["res"];
		$sqlSpørring = "SELECT * FROM Restauranter AS r, Poststed AS p, Tilsynsrapporter AS t WHERE p.postnr = r.postnr AND t.tilsynsobjektid = r.tilsynsobjektid AND r.tilsynsobjektid LIKE '$id'";
			...
			if ($rad) {
				...
				echo "<h1>$navn</h1>";
				echo "<table name='resultatTabell'><th>Organisasjonsnummer</th><th>Adresse</th><th>Postnummer</th><th>Poststed</th><th>Smilefjes-Karakter</th>";
				echo "<tr>";
				echo "<td>$orgnummer</td><td>$adresse</td><td>$postnummer</td><td>$poststed</td><td>$totalkarakter</td>";
				echo "</tr></table>";

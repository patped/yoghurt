		...
		if (mysqli_errno($db)<> 0) {
			...
			<div style='width: 33%; margin: auto'>
				<table class='table table-striped'>
					<tr>
						<th>Feil oppstått</th><th>Feilkoden</th>
					</tr>

					<tr>
						<td>$sqlerror</td><td>$sqlstate</td>
					</tr>

					<tr>
						<td colspan='2'><button type='button' onclick="window.location.href='/admin/ny-bruker.php'">Prøv på nytt</button></td>
					</tr>
				</table>
			</div>
EOT;
			...
			<div class="container text-center">
				<h2>Suksess</h2>
				<h3>Du har registrert følgende bruker: </h3>

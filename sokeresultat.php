...
if (isset($_POST["søkeKnapp"])) {
	...
	$søkeverdi = $_POST["Søkefelt"];
	    ...
	    exit;
			...
			$sqlSpørring = "SELECT r.tilsynsobjektid, r.navn, r.postnr, p.poststed, r.orgnummer FROM Restauranter AS r, Poststed AS p WHERE p.postnr = r.postnr AND r.navn LIKE '%$søkeverdi%' ORDER BY r.navn";
